...
;  let termino_3 list 0 0
  ...
  [
    ...
    set modulo_fuerza_total modulo_fuerza_total + modulo f
]
...
to evacuate
  ...
  ask personas [
    ...
    ;set v_goal list ((item 0 v_goal) * m_g) ((item 1 v_goal) * m_g)
  ...
  ask personas [
    ...
    ; Calculo las fuerzas
    set fuerza_recibe fuerzas
    print modulo_fuerza_total
